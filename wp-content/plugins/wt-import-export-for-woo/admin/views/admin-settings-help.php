	...
	<div class="wt_iew_sub_tab_container">		
		<div class="wt_iew_sub_tab_content" data-id="help-links" style="display:block;">
			...
			<ul class="wf-help-links">
			    <li>
			        <img src="<?php echo WT_IEW_PLUGIN_URL;?>assets/images/documentation.png">
			    ...
			    <li>
			        <img src="<?php echo WT_IEW_PLUGIN_URL;?>assets/images/support.png">
		...
		<div class="wt_iew_sub_tab_content" data-id="help-doc">
			...
			<ul class="wf-help-links">
				<?php do_action( 'wt_user_addon_help_content' ); ?>
				<?php do_action( 'wt_order_addon_help_content' ); ?>
				<?php do_action( 'wt_product_addon_help_content' ); ?>
				<?php do_action( 'wt_coupon_addon_help_content' ); ?>
				<?php do_action( 'wt_subscription_addon_help_content' ); ?>
				<?php do_action( 'wt_review_addon_help_content' ); ?>
			</ul>
		</div>
	</div>
</div>