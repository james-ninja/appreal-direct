...
<div class="wt_iew_import_main">
	...
	<table class="form-table wt-iew-form-table">
		...
		<tr><div id="subscription-required-field-message" class="updated" style="margin-left:0px;display: none;background: #dceff4;"><p><?php _e('Ensure the import file has the user\'s email ID for a successful import. Use default column name <b>customer_email</b> or map the column accordingly if you are using a custom column name.'); ?></p></div></tr>
