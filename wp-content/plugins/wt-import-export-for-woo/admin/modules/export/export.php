	...
	public function __construct()
	{
		...
		(
			'post_type'=>array(
				...
				'description'=>__('Export and download the respective post type into a CSV or XML. This file can also be used to import data related to the specific post type back into your WooCommerce shop. As a first step you need to choose the post type to start the export.'),
			),
			'method_export'=>array(
			...
			'advanced'=>array(
				'title'=>__('Advanced options/Batch export/Scheduling'),
				'description'=>__('Use advanced options from below to decide on the batch export count, schedule an export and/or export images separately. You can also save the template file for future exports.'),
			),
		);
	...
	{		
		$menu_temp=array(
			$this->module_base=>array(
				'menu',
				__('Export'),
				__('WebToffee Import Export (Pro)'),
	...
	*/
	...
	public function get_advanced_screen_fields($advanced_form_data)
	{
		...
		$file_int_field_arr=array(
			'label'=>__("Download the file into my"),
			'type'=>'select',
		...
		{
			$file_int_field_arr['label']=__("Enable FTP export?");
		...
		$advanced_screen_fields=array(
			'file_name'=>array(
				...
				'help_text'=>__('Specify a filename for the exported file. If left blank the system generates a default name.'),
			...
			'export_shortcode_tohtml'=>array(
				'label'=>__("Convert shortcodes to HTML"),
				'value'=>'No',
				'radio_fields'=>array(
					'Yes'=>__('Yes'),
					'No'=>__('No')
				...
				'field_group'=>'advanced_field',
				'help_text'=>__("Option 'Yes' converts the shortcode to HTML within the exported CSV."),
			),
			'batch_count'=>array(
