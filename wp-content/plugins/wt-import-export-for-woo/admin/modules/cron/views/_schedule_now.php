...
<div class="wt_iew_schedule_now wt_iew_popup">
	<div class="wt_iew_popup_hd">
		...
		<span class="wt_iew_popup_hd_label"><?php _e('Schedule now');?></span>
	...
	<div class="wt_iew_schedule_now_box">
		...
		<div class="wt_iew_schedule_now_formrow">
			<div class="wt_iew_schedule_type_box_single" style="margin-bottom:0px;">
				<label for="wt_iew_schedule_wordpress_cron"><input type="radio" name="wt_iew_schedule_type" id="wt_iew_schedule_wordpress_cron" value="wordpress_cron" checked="checked"> <?php _e('Wordpress Cron');?> </label>
			...
			<div class="wt_iew_schedule_type_box_single">
				<label for="wt_iew_schedule_server_cron"><input type="radio" name="wt_iew_schedule_type" id="wt_iew_schedule_server_cron" value="server_cron"> <?php _e('Server Cron');?> </label>
				<p class="wt_iew_schedule_type_desc">
		...
		<div class="wt_iew_schedule_now_formrow">			
			<div class="wt_iew_schedule_now_interval_radio_block">
				<label for="wt_iew_cron_interval_day"><input type="radio" id="wt_iew_cron_interval_day" name="wt_iew_cron_interval" value="day" checked="checked"> <?php _e('Every day');?></label>
				<label for="wt_iew_cron_interval_week"><input type="radio" id="wt_iew_cron_interval_week" name="wt_iew_cron_interval" value="week"> <?php _e('Every week');?></label>
				...
				<label for="wt_iew_cron_interval_month"><input type="radio" id="wt_iew_cron_interval_month" name="wt_iew_cron_interval" value="month"> <?php _e('Every month');?></label>
				<label for="wt_iew_cron_interval_custom"><input type="radio" id="wt_iew_cron_interval_custom" name="wt_iew_cron_interval" value="custom"> <?php _e('Custom');?></label>
			</div>
			<div class="wt_iew_schedule_now_interval_sub_block wt_iew_schedule_custom_interval_block">
				<label><?php _e('Custom interval');?></label>
				<input type="number" step="1" min="1" name="wt_iew_cron_interval_val" value="" placeholder="<?php _e('Interval in minutes.');?>">
		...
		<div class="wt_iew_popup_footer">
			...
			<button type="button" name="" class="button-primary wt_iew_save_schedule"><?php _e('Schedule now');?></button>	
		</div>
	</div>
</div>