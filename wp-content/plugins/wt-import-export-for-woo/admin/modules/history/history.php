	...
	private function view_log($out)
	{
		...
		if($history_id>0)
		{
			...
			if($history_item) //history item exists
			{
				...
				if($action_type=='import' && Wt_Import_Export_For_Woo_Admin::module_exists($action_type))
				{
					...
					{						
						include_once WT_IEW_PLUGIN_PATH.'admin/classes/class-logreader.php';
	...
	*/ 
	public function advanced_setting_fields($fields)
	{
		...
		$fields['enable_history_auto_delete']=array(
			...
			'help_text'=>__('Clicking ‘Yes’ will automatically delete the records in the history section'),
