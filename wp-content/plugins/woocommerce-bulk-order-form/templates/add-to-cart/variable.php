...
<div class="variations_form cart" method="post" enctype='multipart/form-data' data-formid="<?php echo esc_attr( $args['formid'] ); ?>" data-product_id="<?php echo absint( $product->get_id() ); ?>" data-product_variations="<?php echo htmlspecialchars( json_encode( $available_variations ) ) ?>">
