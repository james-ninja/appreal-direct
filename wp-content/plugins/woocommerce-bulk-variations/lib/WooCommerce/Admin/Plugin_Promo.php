...
namespace Barn2\WBV_Lib\WooCommerce\Admin;

use Barn2\WBV_Lib\Admin\Abstract_Plugin_Promo;
use Barn2\WBV_Lib\Admin\Settings_Util;
use Barn2\WBV_Lib\Admin\Plugin_Promo as OG_Promo;
use Barn2\WBV_Lib\Plugin\Plugin;
...
class Plugin_Promo extends Abstract_Plugin_Promo implements Registerable {
	...
	public function barn2_promo_start_field( $field ) {
		...
		<div class="barn2-promo-inner barn2-settings <?php echo esc_attr( $this->plugin->get_slug() . '-settings' ); ?>">
		<?php
	}
