...
class Settings_Util {
	 ...
	 *
	 * @param Barn2\WBV_Lib\Plugin $plugin
		...
		$links = apply_filters(
			...
			[
				'doc'     => [
					...
					'label'  => __( 'Documentation', 'woocommerce-bulk-variations' ),
					'target' => '_blank',
				],
				'support' => [
					'url'    => $plugin->get_support_url(),
					'label'  => __( 'Support', 'woocommerce-bulk-variations' ),
					'target' => '_blank',
				],
			],
			$plugin
