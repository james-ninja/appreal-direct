 ...
 */
namespace Barn2\Plugin\WC_Bulk_Variations\Dependencies\Composer\Autoload;
...
class ClassLoader
{
    ...
    public function findFile($class)
    {
        ...
        if (\false === $file && \defined('Barn2\\Plugin\\WC_Bulk_Variations\\Dependencies\\HHVM_VERSION')) {
