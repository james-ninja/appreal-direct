...
class umTransaction {
	 ...
	 * @param string $refnum
	 */
	public function addLine($sku, $name='', $description='', $cost='', $qty='', $taxable='', $refnum=0)
	{
		if(is_array($sku))
		{
			$vars = $sku;
	...
	public function httpPostCurl($url, $data)
	{
	...
	public function httpPostPHP($url, $data)
	{
