...
<div id="ast_usagedata_connect" class="ud-box-container">
	<div class="ud-content">
	   <h2>Thank you for installing the Advanced Shipment Tracking Pro (AST PRO) plugin</h2>
	   <p>Thank you for updating to Advanced Shipment Tracking Pro (AST PRO)! We recently introduced an opt-in feature that allows us to collect basic usage data from your website.</p>
	...
	<form id="ast_pro_usage_data_form" action="" method="POST">		
		<ul class="ud-checkbox">
			<h4 style="margin: 0 0 10px;">To opt in, please check the boxes below:</h4>
			<li class="">
				<label class="" for="ast_pro_optin_email_notification">
					<input type="hidden" name="ast_pro_optin_email_notification" value="0">
					<input type="checkbox" id="ast_pro_optin_email_notification" name="ast_pro_optin_email_notification" checked="true" value="1">
					<span class="label">Opt in to get email notifications for security & feature updates</span>	
				</label>	
			</li>
			<li class="">
				<label class="" for="ast_pro_enable_usage_data">
					<input type="hidden" name="ast_pro_enable_usage_data" value="0">
					<input type="checkbox" id="ast_pro_enable_usage_data" name="ast_pro_enable_usage_data" checked="true" value="1">
					<span class="label">Opt in to share some basic WordPress environment info</span>	
				</label>	
			</li>
		</ul>
		<div class="ud-actions">
			<input type="hidden" name="action" value="ast_pro_activate_usage_data">
	...
	<form id="ast_pro_skip_usage_data_form" action="" method="POST">
		<input type="hidden" name="action" value="ast_pro_skip_usage_data">
