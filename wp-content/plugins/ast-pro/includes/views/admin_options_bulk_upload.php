	...
	<div class="ast_menu_container">		
		<section class="woocommerce-progress-form-wrapper" style="display:block;">
			...
			<ul class="bulk_upload_documentation_ul">
				<li><span class="dashicons dashicons-download"></span><a class="" href="<?php echo esc_url( ast_pro()->plugin_dir_url() ); ?>assets/tracking.csv"><?php esc_html_e('Download sample csv', 'ast-pro'); ?></a></li>
				<li><span class="dashicons dashicons-media-document"></span><a target="blank" href="https://www.zorem.com/docs/woocommerce-advanced-shipment-tracking/bulk-import-shipment-tracking/"><?php esc_html_e('How to import tracking number from CSV files?', 'ast-pro'); ?></a></li>	
			</ul>	
		</section>	
	</div>	
</div>
