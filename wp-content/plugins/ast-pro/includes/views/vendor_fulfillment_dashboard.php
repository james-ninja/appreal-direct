...
<p class="fulfillment_search_box">
	...
	<input type="search" id="fulfillment_search_input" name="fulfillment_search_input" class="fulfillment_search_input" value="" placeholder="<?php esc_html_e('Order ID', 'ast-pro'); ?>">
