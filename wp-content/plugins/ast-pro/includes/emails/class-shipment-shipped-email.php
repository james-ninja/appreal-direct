...
if ( ! class_exists( 'WC_Email_Customer_Shipped_Order', false ) ) :
	...
	class WC_Email_Customer_Shipped_Order extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Shipped order', 'ast-pro' );
			$this->description    = __( 'Order shipped emails are sent to customers when their orders are marked shipped and usually indicate that their orders have been shipped.', 'ast-pro' );
		...
		public function get_default_subject() {
			return __( 'Your {site_title} order is now Shipped', 'ast-pro' );
		}
		...
		public function get_default_heading() {
			return __( 'Your Order is Shipped', 'ast-pro' );
		}
