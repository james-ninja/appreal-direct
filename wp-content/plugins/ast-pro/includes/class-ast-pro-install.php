...
class AST_PRO_Install {
	...
	*/
	 ...
	 * 
	*/	
	public function ast_pro_install() {
		
		deactivate_plugins('woo-advanced-shipment-tracking/woocommerce-advanced-shipment-tracking.php' );
		deactivate_plugins('paypal-tracking-add-on-for-ast/paypal-tracking-add-on-for-ast.php' );		
	...
	*/
	public function update_database_check() {					
		if ( is_admin() ) {		
			...
			if ( version_compare( get_option( 'ast_pro_update_version', '1.0' ), '1.1', '<' ) ) {				
				deactivate_plugins('woo-advanced-shipment-tracking/woocommerce-advanced-shipment-tracking.php' );
				deactivate_plugins('paypal-tracking-add-on-for-ast/paypal-tracking-add-on-for-ast.php' );
				$this->create_shippment_tracking_table();
				$this->update_shipping_providers();					
