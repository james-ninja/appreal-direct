 ...
 */
class Ast_Pro_Partial_Shipped_Customizer_Email {
	...
	*/
	...
	public function is_own_customizer_request() {
		return isset( $_REQUEST['email'] ) && 'custom_partially_shipped_email' === $_REQUEST['email'];
	}
	...
	public function get_customizer_url( $email, $order_status ) {		
		return add_query_arg( array(
			...
			'autofocus[section]' => 'custom_partially_shipped_email',
	...
	*/
	public function wcast_generate_defaults() {
		$customizer_defaults = array(			
			'wcast_partial_shipped_email_subject' => __( 'Your {site_title} order is now partially shipped', 'ast-pro' ),
			'wcast_partial_shipped_email_heading' => __( 'Your Order is Partially Shipped', 'ast-pro' ),
			'wcast_partial_shipped_email_content' => __( "Hi there. we thought you'd like to know that your recent order from {site_title} has been partially shipped.", 'ast-pro' ),				
	...
	public function wcast_register_sample_default_controls( $wp_customize ) {		
		...
		*/
		...
		$wp_customize->add_control( 'customizer_partial_shipped_order_settings_enabled',
			array(
				'label' => __( 'Enable Partially Shipped order status email', 'ast-pro' ),
				'description' => '',
				'section' => 'custom_partially_shipped_email',
				'type' => 'checkbox',
			)
		);				
		...
		$wp_customize->add_control( 'woocommerce_customer_partial_shipped_order_settings[subject]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wcast_partial_shipped_email_subject'], 'ast-pro' ),
				),
			)
		);
		...
		$wp_customize->add_control( 'woocommerce_customer_partial_shipped_order_settings[heading]',
			array(
				...
				'input_attrs' => array(
					'class' => '',
					'style' => '',
					'placeholder' => __( $this->defaults['wcast_partial_shipped_email_heading'], 'ast-pro' ),
				),
			)
		);
		...
		$wp_customize->add_control( new AST_TinyMCE_Custom_control( $wp_customize, 'woocommerce_customer_partial_shipped_order_settings[wcast_partial_shipped_email_content]',
			array(
				...
				'input_attrs' => array(
					...
					'mediaButtons' => true,
					'placeholder' => __( $this->defaults['wcast_partial_shipped_email_content'], 'ast-pro' ),
				),
			)
		) );						
		...
		$wp_customize->add_setting( 'woocommerce_customer_partial_shipped_order_settings[display_options]',
			array(
				'default' => '',
				'transport' => 'postMessage',
				'sanitize_callback' => '',
		...
		$wp_customize->add_control( new WP_Customize_Heading_Control( $wp_customize, 'woocommerce_customer_partial_shipped_order_settings[display_options]',
			array(
		...
		$wp_customize->add_setting( 'woocommerce_customer_partial_shipped_order_settings[shipping_items_heading]',
			array(
		...
		$wp_customize->add_control( 'woocommerce_customer_partial_shipped_order_settings[shipping_items_heading]',
			array(
		...
		$wp_customize->add_setting( 'woocommerce_customer_partial_shipped_order_settings[display_shippment_item_price]',
			array(
		...
		$wp_customize->add_control( 'woocommerce_customer_partial_shipped_order_settings[display_shippment_item_price]',
			array(
		...
		$wp_customize->add_setting( 'woocommerce_customer_partial_shipped_order_settings[display_product_images]',
			array(
		...
		$wp_customize->add_control( 'woocommerce_customer_partial_shipped_order_settings[display_product_images]',
			array(
		...
		$wp_customize->add_setting( 'woocommerce_customer_partial_shipped_order_settings[display_shipping_address]',
			array(
		...
		$wp_customize->add_control( 'woocommerce_customer_partial_shipped_order_settings[display_shipping_address]',
			array(
		...
		$wp_customize->add_setting( 'woocommerce_customer_partial_shipped_order_settings[display_billing_address]',
			array(
		...
		$wp_customize->add_control( 'woocommerce_customer_partial_shipped_order_settings[display_billing_address]',
			array(
	...
	public function set_up_preview() {		
		...
		include ast_pro()->get_plugin_path() . '/includes/customizer/preview/partial_shipped_preview.php';
		exit;			
	}
...
*/
function ast_pro_ps_customizer() {
	static $instance;

	if ( ! isset( $instance ) ) {		
		$instance = new ast_pro_partial_shipped_customizer_email();
	}
...
*/
ast_pro_ps_customizer();

add_action( 'customize_save_customizer_partial_shipped_order_settings_enabled', 'ast_pro_customer_partial_shipped_order_settings_fun', 100, 1 ); 

/**
 * Update Delivered order email enable/disable
 *
 */
function ast_pro_customer_partial_shipped_order_settings_fun( $data ) {
