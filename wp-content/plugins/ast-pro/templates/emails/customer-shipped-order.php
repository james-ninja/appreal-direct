...
$display_shipping_address = $ast->get_checkbox_option_value_from_array( 'woocommerce_customer_shipped_order_settings', 'display_shipping_address', $ast_customizer->defaults['display_shipping_address'] );
$display_billing_address = $ast->get_checkbox_option_value_from_array( 'woocommerce_customer_shipped_order_settings', 'display_billing_address', $ast_customizer->defaults['display_billing_address'] );

$email_content = $ast->get_option_value_from_array( 'woocommerce_customer_shipped_order_settings', 'wcast_shipped_email_content', $ast_customizer->defaults['shipped_email_content'] );
...
$shipping_items_heading = $ast->get_option_value_from_array( 'woocommerce_customer_shipped_order_settings', 'shipping_items_heading', $ast_customizer->defaults['shipping_items_heading'] );
