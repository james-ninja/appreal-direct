...
$shipped_settings = new wcast_shipped_customizer_email();
$ast = new AST_Pro_Actions();

$display_shipping_items = $ast->get_checkbox_option_value_from_array( 'woocommerce_customer_shipped_order_settings', 'display_shipping_items', $shipped_settings->defaults['display_shipping_items'] );	
$display_shipping_address = $ast->get_checkbox_option_value_from_array( 'woocommerce_customer_shipped_order_settings', 'display_shipping_address', $shipped_settings->defaults['display_shipping_address'] );
$display_billing_address = $ast->get_checkbox_option_value_from_array( 'woocommerce_customer_shipped_order_settings', 'display_billing_address', $shipped_settings->defaults['display_billing_address'] );

$email_content = $ast->get_option_value_from_array( 'woocommerce_customer_shipped_order_settings', 'wcast_shipped_email_content', $shipped_settings->defaults['wcast_shipped_email_content'] );
