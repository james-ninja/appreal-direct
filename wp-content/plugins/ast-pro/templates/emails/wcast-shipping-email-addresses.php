...
if ( !empty($shipping) ) { 
	?>
	<table id="addresses" cellspacing="0" cellpadding="0" style="width: 48%;display:inline-block;vertical-align: top; margin: 20px 0; padding:0;border: 0;margin-right: 15px;" border="0">
		<tr>				
