...
$display_shipping_address = $ast->get_checkbox_option_value_from_array( 'woocommerce_customer_partial_shipped_order_settings', 'display_shipping_address', $ast_customizer->defaults['display_shipping_address'] );
$display_billing_address = $ast->get_checkbox_option_value_from_array( 'woocommerce_customer_partial_shipped_order_settings', 'display_billing_address', $ast_customizer->defaults['display_billing_address'] );
...
$shipping_items_heading = $ast->get_option_value_from_array( 'woocommerce_customer_partial_shipped_order_settings', 'shipping_items_heading', $ast_customizer->defaults['shipping_items_heading'] );

$display_shippment_item_price = $ast->get_checkbox_option_value_from_array( 'woocommerce_customer_partial_shipped_order_settings', 'display_shippment_item_price', $ast_customizer->defaults['display_shippment_item_price'] );

$display_product_images = $ast->get_checkbox_option_value_from_array( 'woocommerce_customer_partial_shipped_order_settings', 'display_product_images', $ast_customizer->defaults['display_product_images'] );
