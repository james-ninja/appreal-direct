...
if (!class_exists('CWG_Instock_Settings')) {
	...
	class CWG_Instock_Settings {
		...
		public function add_settings_menu() {
			add_submenu_page('edit.php?post_type=cwginstocknotifier', __('Settings', 'back-in-stock-notifier-for-wooscommerce'), __('Settings', 'back-in-stock-notifier-for-wooscommerce'), 'manage_woocommerce', 'cwg-instock-mailer', array($this, 'manage_settings'));
		}
			...
			<select name = "cwginstocksettings[mode]">  
				...
				if (is_array($array_of_modes) && !empty($array_of_modes)) {
					foreach ($array_of_modes as $each_key => $each_value) {
						...
						?>
						<option value = "<?php echo do_shortcode($each_key); ?>" <?php echo do_shortcode($chosen_mode); ?>><?php echo do_shortcode($each_value); ?></option>
						<?php
					}
				}
				?>
		...
		public function form_title() {
			$options = get_option('cwginstocksettings');
			?>
			<input type='text' style='width: 400px;' name='cwginstocksettings[form_title]' value="<?php echo wp_kses_post($this->api->sanitize_text_field($options['form_title'])); ?>"/>
			<?php
		}
		...
		public function form_name_placeholder() {
			...
			?>
			<input type='text' style='width: 400px;' name='cwginstocksettings[name_placeholder]' value="<?php echo wp_kses_post($this->api->sanitize_text_field($option_value)); ?>"/>
			<?php
		}
		...
		public function form_email_placeholder() {
			$options = get_option('cwginstocksettings');
			?>
			<input type='text' style='width: 400px;' name='cwginstocksettings[form_placeholder]' value="<?php echo wp_kses_post($this->api->sanitize_text_field($options['form_placeholder'])); ?>"/>
			<?php
		}
		...
		public function button_label() {
			$options = get_option('cwginstocksettings');
			?>
			<input type='text' style='width: 400px;' name='cwginstocksettings[button_label]' value="<?php echo wp_kses_post($this->api->sanitize_text_field($options['button_label'])); ?>"/>
			<?php
		}
		...
		public function hide_name_field() {
			...
			<p><i><?php esc_html_e('Hide name field in Subscribe Form', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function show_phone_field() {
			...
			<p><i><?php esc_html_e('Show phone field in Subscribe Form', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function hide_form_for_guest() {
			...
			<p><i><?php esc_html_e('Hide Subscribe Form for non logged-in Users', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function hide_form_for_member() {
			...
			<p><i><?php esc_html_e('Hide Subscribe Form for logged-in Users', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function show_form_for_backorders() {
			...
			<p><i><?php esc_html_e('Display Subscribe Form for Back Order', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function show_subscribe_button_catalog() {
			$options = get_option('cwginstocksettings');
			?>
			<input type="checkbox" name="cwginstocksettings[show_subscribe_button_catalog]" <?php isset($options['show_subscribe_button_catalog']) ? checked($options['show_subscribe_button_catalog'], 1) : ''; ?> value="1"/>
			<p><i><?php esc_html_e('Display Subscribe Now Button in Catalog Page', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function hide_readmore_button_catalog() {
			...
			<p><i><?php esc_html_e('Hide Read more button in catalog page(shop/category)', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function visibility_for_specific_products() {
			$options = get_option('cwginstocksettings');
			?>
			<select style="width:320px;" data-placeholder="<?php esc_html_e('Select Products', 'back-in-stock-notifier-for-woocommerce'); ?>" data-allow_clear="true" tabindex="-1" aria-hidden="true" name="cwginstocksettings[specific_products][]" multiple="multiple" class="wc-product-search">
				<?php
			...
			<label><input type="radio" name="cwginstocksettings[specific_products_visibility]" <?php isset($options['specific_products_visibility']) ? checked($options['specific_products_visibility'], 1) : ''; ?> value="1"/> <?php esc_html_e('Show', 'back-in-stock-notifier-for-woocommerce'); ?></label>
			<label><input type="radio" name="cwginstocksettings[specific_products_visibility]" <?php isset($options['specific_products_visibility']) ? checked($options['specific_products_visibility'], 2) : ''; ?> value="2"/> <?php esc_html_e('Hide', 'back-in-stock-notifier-for-woocommerce'); ?></label>
			<p><i><?php esc_html_e('By Default this field will empty means subscribe form will shown to all out of stock products by default', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function visibility_for_specific_categories() {
			$options = get_option('cwginstocksettings');
			?>
			<select style="width:320px;" data-placeholder="<?php esc_html_e('Select Categories', 'back-in-stock-notifier-for-woocommerce'); ?>" data-allow_clear="true" name="cwginstocksettings[specific_categories][]" multiple="multiple" class="wc-category-search">
				<?php
			...
			<label><input type="radio" name="cwginstocksettings[specific_categories_visibility]" <?php isset($options['specific_categories_visibility']) ? checked($options['specific_categories_visibility'], 1) : ''; ?> value="1"/> <?php esc_html_e('Show', 'back-in-stock-notifier-for-woocommerce'); ?></label>
			<label><input type="radio" name="cwginstocksettings[specific_categories_visibility]" <?php isset($options['specific_categories_visibility']) ? checked($options['specific_categories_visibility'], 2) : ''; ?> value="2"/> <?php esc_html_e('Hide', 'back-in-stock-notifier-for-woocommerce'); ?></label>
			<p><i><?php esc_html_e('By Default this field will empty means subscribe form will shown to all out of stock products by default', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function visibility_for_specific_tags() {
			$options = get_option('cwginstocksettings');
			?>
			<select style="width:320px;" data-placeholder="<?php esc_html_e('Select Product Tags', 'back-in-stock-notifier-for-woocommerce'); ?>" data-allow_clear="true" name="cwginstocksettings[specific_tags][]" multiple="multiple" class="wc-tag-search">
				<?php
			...
			<label><input type="radio" name="cwginstocksettings[specific_tags_visibility]" <?php isset($options['specific_tags_visibility']) ? checked($options['specific_tags_visibility'], 1) : ''; ?> value="1"/> <?php esc_html_e('Show', 'back-in-stock-notifier-for-woocommerce'); ?></label>
			<label><input type="radio" name="cwginstocksettings[specific_tags_visibility]" <?php isset($options['specific_tags_visibility']) ? checked($options['specific_tags_visibility'], 2) : ''; ?> value="2"/> <?php esc_html_e('Hide', 'back-in-stock-notifier-for-woocommerce'); ?></label>
			<p><i><?php esc_html_e('By Default this field will empty means subscribe form will shown to all out of stock products by default', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function visibility_settings_for_product_on_sale() {
			...
			<p><i><?php esc_html_e('Hide Subscribe Form on Sale Products out of stock', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function disabled_variation_settings_option() {
			...
			<p><i><?php esc_html_e('Enable this option to not overwrite disabled out of stock variation settings from themes(some themes)', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function ignore_settings_for_wc_out_of_stock_visibility() {
			...
			<p><i><?php esc_html_e('Enable this option to ignore WooCommerce Out of stock Visibility Settings for Variations', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function visibility_settings_for_product_on_regular() {
			...
			<p><i><?php esc_html_e('Hide Subscribe Form on Regular Products out of stock', 'back-in-stock-notifier-for-woocommerce'); ?></i></p>
			<?php
		}
		...
		public function empty_name_fields() {
			...
			?>
			<input type='text' style='width: 400px;' name='cwginstocksettings[empty_name_message]' value="<?php echo wp_kses_post($this->api->sanitize_text_field($option_value)); ?>"/>
			<?php
		}
		...
		public function empty_email_address() {
			$options = get_option('cwginstocksettings');
			?>
			<input type='text' style='width: 400px;' name='cwginstocksettings[empty_error_message]' value="<?php echo wp_kses_post($this->api->sanitize_text_field($options['empty_error_message'])); ?>"/>
			<?php
		}
		...
		public function invalid_email_address() {
			$options = get_option('cwginstocksettings');
			?>
			<input type='text' style='width: 400px;' name='cwginstocksettings[invalid_email_error]' value="<?php echo wp_kses_post($this->api->sanitize_text_field($options['invalid_email_error'])); ?>"/>
			<?php
		}
		...
		public function invalid_phone_number() {
			...
			?>
			<input type='text' style='width: 400px;' name='cwginstocksettings[invalid_phone_error]' value="<?php echo wp_kses_post($this->api->sanitize_text_field($invalid_phone_number)); ?>"/>
			<?php
		}
		...
		public function phone_number_too_short() {
			...
			?>
			<input type='text' style='width: 400px;' name='cwginstocksettings[phone_number_too_short]' value="<?php echo wp_kses_post($this->api->sanitize_text_field($phone_number_too_short)); ?>"/>
			<?php
		}
		...
		public function phone_number_too_long() {
			...
			?>
			<input type='text' style='width: 400px;' name='cwginstocksettings[phone_number_too_long]' value="<?php echo wp_kses_post($this->api->sanitize_text_field($phone_number_too_long)); ?>"/>
			<?php
		}
		...
		public function mail_settings_heading() {
			...
			echo '<strong>{product_name}, {product_id}, {product_link}, {shopname}, {email_id}, {subscriber_email}, {subscriber_name}, {subscriber_phone}, {cart_link}, {only_product_name}, {only_product_sku}, {product_image}</strong>';
		...
		public function success_subscription_mail_subject() {
			$options = get_option('cwginstocksettings');
			?>
			<input type='text' style='width: 400px;' name='cwginstocksettings[success_sub_subject]' value="<?php echo wp_kses_post($this->api->sanitize_text_field($options['success_sub_subject'])); ?>"/>
			<?php
		}
		...
		public function success_subscription_mail_message() {
			$options = get_option('cwginstocksettings');
			?>
			<textarea rows="15" cols="50" name="cwginstocksettings[success_sub_message]"><?php echo wp_kses_post($this->api->sanitize_textarea_field($options['success_sub_message'])); ?></textarea>
			<?php
		}
		...
		public function subscription_copy_recipients() {
			$options = get_option('cwginstocksettings');
			?>
			<textarea rows='15' cols='50' name='cwginstocksettings[subscription_copy_recipients]'><?php echo wp_kses_post(isset($options['subscription_copy_recipients']) ? $options['subscription_copy_recipients'] : ''); ?></textarea>
			<?php
		}
		...
		public function instock_mail_subject() {
			$options = get_option('cwginstocksettings');
			?>
			<input type='text' style='width: 400px;' name='cwginstocksettings[instock_mail_subject]' value="<?php echo wp_kses_post($this->api->sanitize_text_field($options['instock_mail_subject'])); ?>"/>
			<?php
		}
		...
		public function instock_mail_message() {
			$options = get_option('cwginstocksettings');
			?>
			<textarea rows="15" cols="50" name="cwginstocksettings[instock_mail_message]"><?php echo wp_kses_post($this->api->sanitize_textarea_field($options['instock_mail_message'])); ?></textarea>
			<?php
		}
		...
		public function instock_mail_message_set_stock_quantity() {
			...
			?>
			<input type='number' style='width: 400px;' name='cwginstocksettings[set_stock_quantity_for_instock_mail]' value="<?php echo wp_kses_post($get_option_value_user); ?>" step="any"/>
			<i><p>Using this option Instock Email trigger can be controllable, when you manage product stock by quantity. For Ex: If you set 5 in this option, you have to update product stock more than or equal to 5 in product stock quantity in order to trigger instock email</p></i>
			<?php
		}
