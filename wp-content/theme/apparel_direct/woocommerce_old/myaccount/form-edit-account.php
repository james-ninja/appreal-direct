...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action('woocommerce_edit_account_form_tag'); ?>>
	...
	<div class="step_form panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title" data-toggle="collapse" data-target="#collapseOne">Profile</h3>
		</div>
	...
	<?php */ ?>
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
					<label for="account_email"><?php esc_html_e('Account Email address', 'woocommerce'); ?>&nbsp;<span class="required">*</span></label>
