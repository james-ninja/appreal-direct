...
?>
	...
	<?php $header_banner_image = get_field('header_banner_image'); 
		...
		if(empty($header_banner_image['url'])){
			$header_banner_image['url'] = get_template_directory_uri().'/assets/images/inner-banner.jpg';
		}
	?>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<h2 class="text-center text-uppercase"><?php woocommerce_page_title(); ?></h2>
	...
	<div class="row">
		...
		<div class="col-lg-9">
			<?php
				...
				echo do_shortcode('[facetwp facet="per_page"]');
