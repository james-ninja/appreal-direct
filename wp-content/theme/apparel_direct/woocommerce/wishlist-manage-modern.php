			...
			<li data-wishlist-id="<?php echo esc_attr( $wishlist->get_id() ); ?>">
				<div class="item-wrapper">
					<div class="item-details">
						...
						//custom end
						?>
						<div class="item-details-table-custom">
						<?php if ( $show_number_of_items ) : ?>
					...
					<div class="product-thumbnail">
						...
						if ( $wishlist->has_items() ) :
							...
							foreach ( $items as $item ) {
								...
								if($variation_image) {
								?>
								<a class="wishlist-anchor" href="<?php echo esc_url( $wishlist->get_url() ); ?>"><img src="<?php echo $variation_image; ?>" /></a>
								<?php } else { ?>
								<a class="wishlist-anchor" href="<?php echo esc_url( $wishlist->get_url() ); ?>"><?php echo $item->get_product()->get_image(); ?></a>
								<?php
								}
							}
						else :
							...
							<div class="placeholder-item empty-box">
								<p><?php echo wp_kses_post( apply_filters('yith_wcwl_modern_wishlist_empty_message', __( 'This wishlist is empty.<br/>Add some items soon!', 'yith-woocommerce-wishlist' ) ) ); ?></p>
							</div>
							<?php
						endif;
						?>
