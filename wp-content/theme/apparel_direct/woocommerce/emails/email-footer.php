									                    ...
									                    <tbody>
									                        <tr>
									                            <td colspan="2" id="credit" style="border-radius: 6px; border: 0; font-family: &quot;Helvetica Neue&quot;, Helvetica, Roboto, Arial, sans-serif; font-size: 14px; line-height: 150%; text-align: center; padding: 24px 0; padding-bottom: 0px;" valign="middle">
									                                <p style="margin: 0 0 16px;"><a href="http://appareldirectdistributor.com" style="color: #fff; text-decoration:none;"><?php echo wp_kses_post(wpautop(wptexturize(apply_filters('woocommerce_email_footer_text', get_option('woocommerce_email_footer_text'))))); ?></a></p>
									                                                                                                                    ...
									                                                                                                                    <tbody>
									                                                                                                                        <tr>
									                                                                                                                            <td class="mcnFollowIconContent" width="24" valign="middle" align="center" style=" padding-right:10px;">
									                                                                                                                                <a href="#" target="_blank"><img src="<?php echo get_template_directory_uri() ?>/assets/images/facebook-img.png" style="display:block;" class="" width="24" height="24"></a>
									                                                                                                                            </td>
									                                                                                                                            <td class="mcnFollowIconContent" width="24" valign="middle" align="center" style=" padding-right:10px;padding-left:9px;">
									                                                                                                                                <a href="#" target="_blank"><img src="<?php echo get_template_directory_uri() ?>/assets/images/twitter-img.png?>" style="display:block;" class="" width="24" height="24"></a>
									                                                                                                                            </td>
									                                                                                                                            <td class="mcnFollowIconContent" width="24" valign="middle" align="center" style=" padding-right:10px;padding-left:9px;">
									                                                                                                                                <a href="#" target="_blank"><img src="<?php echo get_template_directory_uri() ?>/assets/images/instagram-img.png" style="display:block;" class="" width="24" height="24"></a>
									                                                                                                                            </td>
									                                                                                                                        </tr>
									                                                                                                                    </tbody>
									                                                                                                                </table>
